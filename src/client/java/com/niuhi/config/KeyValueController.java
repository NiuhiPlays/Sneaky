...
public class KeyValueController<K, V> implements Controller<KeyValueController.KeyValuePair<K, V>> {
    ...
    private final Controller keyController;
    ...
    public AbstractWidget provideWidget(YACLScreen screen, Dimension<Integer> widgetDimension) {
        return new KeyValueControllerElement(this, screen, widgetDimension);
    }

    public class KeyValueControllerElement extends ControllerWidget<KeyValueController<K, V>> {
        private final AbstractWidget keyElement;
        private final AbstractWidget valueElement;

        public KeyValueControllerElement(KeyValueController<K, V> control, YACLScreen screen, Dimension<Integer> dim) {
